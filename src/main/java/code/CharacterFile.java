...
import code.cards.LambsRespite;
...
import code.relics.MaskOfTheKindred;

import java.util.ArrayList;

import static code.CharacterFile.Enums.KINDRED_COLOR;
...
public class CharacterFile extends CustomPlayer {
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(LambsRespite.ID);
        return retVal;
    }

    public ArrayList<String> getStartingRelics() {
        ArrayList<String> retVal = new ArrayList<>();
        retVal.add(MaskOfTheKindred.ID);
        return retVal;
    }
    ...
    public static class Enums {
        //TODO: Change these.
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_ETERNAL_HUNTERS;
        @SpireEnum(name = "KINDRED_COLOR")
        public static AbstractCard.CardColor KINDRED_COLOR;
        @SpireEnum(name = "KINDRED_COLOR")
